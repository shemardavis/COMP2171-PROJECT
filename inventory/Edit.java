...
public class Edit extends JFrame {
	...
	public Edit() {
        ...
        iLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        JLabel nLabel = new JLabel("Product name:");
        nLabel.setBounds(0, 61, 884, 49);
        nLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        JLabel qLabel = new JLabel("Product quantity:");
        qLabel.setBounds(0, 120, 884, 49);
        qLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        JLabel pLabel = new JLabel("Product price:");
        pLabel.setBounds(0, 179, 884, 49);
        pLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        ...
        enter.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        clear = new JButton("Clear");
        clear.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
        ...
        msg = new JLabel("Enter product ID for the item you wish to edit and new name/quantity/price in the relevant field(s)");
        msg.setFont(new Font("Segoe UI Variable", Font.PLAIN, 17));
        ...
        btnNewButton_2.setFont(new Font("Segoe UI Variable", Font.PLAIN, 15));
