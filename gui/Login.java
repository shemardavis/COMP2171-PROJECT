...
public class Login extends JPanel
{
    ...
    public Login()
    {
        ...
        uLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 14));
        ...
        passwordLabel.setFont(new Font("Segoe UI Variable", Font.PLAIN, 14));
        passwordLabel.setBounds(0, 83, 349, 24);
        inputPanel.add(passwordLabel);
        passwordField.setBounds(162, 78, 456, 40);
        inputPanel.add(passwordField);
        showPassword.setFont(new Font("Segoe UI Variable", Font.PLAIN, 12));
            ...
            if(event.getSource() == submit)
            {
                ...
                if(uname.getText().length() > 0 && pwdText.length() > 0) //Ensures all fields are completed
                {
                    if (isValidPassword(pwdText)){ //Check password is valid
                    		confirmMsg.setText("New user has been succesfully added!");
                    }
                } else {
