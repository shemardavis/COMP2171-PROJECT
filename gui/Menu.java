...
import checkout.Cashier;
import inventory.StockList;
import supplier.SupplierManagement;
...
public class Menu extends JFrame {
	...
	public Menu() {
        ...
        stockList.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
        stockList.setBounds(127, 103, 221, 50);
        salesReport = new JButton("View and Export Report");
        salesReport.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
        salesReport.setBounds(127, 222, 221, 50);
        cashier = new JButton("Conduct Transaction");
        cashier.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
        cashier.setBounds(503, 222, 221, 50);
        suppManagement = new JButton("View and Modify Suppliers");
        suppManagement.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
        suppManagement.setBounds(503, 103, 221, 50);
        ...
        lblNewLabel = new JLabel("SELECT AN OPTION");
