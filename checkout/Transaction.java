...
public class Transaction extends JFrame {
	...
	public Transaction() {
		...
		lblNewLabel_1_1.setFont(new Font("Segoe UI Variable", Font.PLAIN, 17));
		...
		enter.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
		enter.setBounds(740, 99, 96, 29);
		enter.addActionListener(buttonListener);
		contentPane.add(enter);
		
		clear = new JButton("Clear");
		clear.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
		clear.setBounds(740, 151, 96, 29);
		clear.addActionListener(buttonListener);
		contentPane.add(clear);
		
		done = new JButton("Done");
		done.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
		...
		btnBack.setFont(new Font("Segoe UI Variable", Font.PLAIN, 16));
